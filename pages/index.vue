  ...
  <div class="landing">
    <div class="banner-wrapper">
      ...
      <div class="banner">
        ...
        <img class="banner-image" src="~/assets/banner-image.png" alt="banner image">
    ...
    <div class="unicorn-with-whale popup-container">
      ...
      <div class="dialog-boxes popup-box">
        ...
        <div class="whale-box">
          <div class="dialog-name">WHALEY THE SHARK</div>
          <p class="dialog-p">I make healthy food in the Cooking tab and make sure to exercise in the Movement Space! It's great because the more I go there to dance the better I get, soon I'll be able to earn Bright for my performances! I better get back to meditating!</p>
        </div>
      </div>
    ...
    <div class="button-group">
      ...
      <button href="https://byzantine.network/spacequest/getspace/" class="ready-btn">READY PLAYA?</button>
    </div>
